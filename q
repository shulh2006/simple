...
OOPPTTIIOONNSS
       ...
       -L <start>,<end>:<file>, -L :<funcname>:<file>
           ...
           from a single revision, i.e., you may only give zero or one positive revision arguments, and <start> and
           <end> (or <funcname>) must exist in the starting revision. You can specify this option more than once.
   ...
   CCoommmmiitt LLiimmiittiinngg
       ...
       --alternate-refs
           ...
           An alternate repository is any repository whose object directory is specified in oobbjjeeccttss//iinnffoo//aalltteerrnnaatteess.
           The set of included objects may be modified by ccoorree..aalltteerrnnaatteeRReeffssCCoommmmaanndd, etc. See ggiitt--ccoonnffiigg(1).
   ...
   CCoommmmiitt FFoorrmmaattttiinngg
       --pretty[=<format>], --format=<format>
           ...
           _s_h_o_r_t, _m_e_d_i_u_m, _f_u_l_l, _f_u_l_l_e_r, _r_e_f_e_r_e_n_c_e, _e_m_a_i_l, _r_a_w, _f_o_r_m_a_t_:_<_s_t_r_i_n_g_> and _t_f_o_r_m_a_t_:_<_s_t_r_i_n_g_>. When _<_f_o_r_m_a_t_> is
           none of the above, and has _%_p_l_a_c_e_h_o_l_d_e_r in it, it acts as if _-_-_p_r_e_t_t_y_=_t_f_o_r_m_a_t_:_<_f_o_r_m_a_t_> were given.
   ...
   DDiiffff FFoorrmmaattttiinngg
       ...
       --combined-all-paths
           This flag causes combined diffs (used for merge commits) to list the name of the file from all parents. It
           thus only has effect when -c or --cc are specified, and is likely only useful if filename changes are
           detected (i.e. when either rename or copy detection have been requested).
...
PPRREETTTTYY FFOORRMMAATTSS
       ...
       •   _r_e_f_e_r_e_n_c_e
           ...
           ----pprreettttyy==''ffoorrmmaatt::%%CC((aauuttoo))%%hh ((%%ss,, %%aadd))''. By default, the date is formatted with ----ddaattee==sshhoorrtt unless another
           ----ddaattee option is explicitly specified. As with any ffoorrmmaatt:: with format placeholders, its output is not
       ...
       •   _f_o_r_m_a_t_:_<_s_t_r_i_n_g_>
           ...
           •   Placeholders that affect formatting of later placeholders:
               ...
               _%_C_(_._._._)
                   ...
                   ccoonnffiigg(1). By default, colors are shown only when enabled for log output (by ccoolloorr..ddiiffff, ccoolloorr..uuii,
                   or ----ccoolloorr, and respecting the aauuttoo settings of the former if we are going to a terminal).
                   %%CC((aauuttoo,,......))  is accepted as a historical synonym for the default (e.g., %%CC((aauuttoo,,rreedd))). Specifying
                   %%CC((aallwwaayyss,,......))  will show the colors even when color is not otherwise enabled (though consider
                   just using ----ccoolloorr==aallwwaayyss to enable color for the whole output, including this format and anything
                   else git might color).  aauuttoo alone (i.e.  %%CC((aauuttoo))) will turn on auto coloring on the next
           ...
           •   Placeholders that expand to information extracted from the commit:
               ...
               _%_c_L
                   author local-part (see _%_c_l) respecting .mailmap, see ggiitt--sshhoorrttlloogg(1) or ggiitt--bbllaammee(1))
               ...
               _%_g_d
                   shortened reflog selector; same as %%ggDD, but the refname portion is shortened for human readability
                   (so rreeffss//hheeaaddss//mmaasstteerr becomes just mmaasstteerr).
               ...
               _%_(_t_r_a_i_l_e_r_s_[_:_o_p_t_i_o_n_s_]_)
                   ...
                   may be followed by a colon and zero or more comma-separated options:
                   ...
                   •   _o_n_l_y_[_=_v_a_l_]: select whether non-trailer lines from the trailer block should be included. The
                       oonnllyy keyword may optionally be followed by an equal sign and one of ttrruuee, oonn, yyeess to omit or
                       ffaallssee, ooffff, nnoo to show the non-trailer lines. If option is given without value it is enabled.
                       If given multiple times the last value is used.
                   ...
                   •   _s_e_p_a_r_a_t_o_r_=_<_S_E_P_>: specify a separator inserted between trailer lines. When this option is not
                       ...
                       it would otherwise be parsed as next option. If separator option is given multiple times only
                       the last one is used. E.g., %%((ttrraaiilleerrss::kkeeyy==TTiicckkeett,,sseeppaarraattoorr==%%xx22CC )) shows all trailer lines
                       whose key is "Ticket" separated by a comma and a space.

                   •   _u_n_f_o_l_d_[_=_v_a_l_]: make it behave as if interpret-trailer’s ----uunnffoolldd option was given. In same way
                       as to for oonnllyy it can be followed by an equal sign and explicit value. E.g.,
                       %%((ttrraaiilleerrss::oonnllyy,,uunnffoolldd==ttrruuee)) unfolds and shows all trailer lines.

                   •   _v_a_l_u_e_o_n_l_y_[_=_v_a_l_]: skip over the key part of the trailer line and only show the value part. Also
...
CCOOMMMMOONN DDIIFFFF OOPPTTIIOONNSS
       ...
       -U<n>, --unified=<n>
           Generate diffs with <n> lines of context instead of the usual three. Implies ----ppaattcchh. Implies --pp.
       ...
       --color-moved[=<mode>]
           ...
           blocks
               ...
               are painted using either the _c_o_l_o_r_._d_i_f_f_._{_o_l_d_,_n_e_w_}_M_o_v_e_d color. Adjacent blocks cannot be told apart.
       ...
       --abbrev[=<n>]
           ...
           lines, show only a partial prefix. This is independent of the ----ffuullll--iinnddeexx option above, which controls
           the diff-patch output format. Non default number of digits can be specified with ----aabbbbrreevv==<<nn>>.
       ...
       -B[<n>][/<m>], --break-rewrites[=[<n>][/<m>]]
           ...
           considers a file that disappeared as the source of a rename), and the number nn controls this aspect of the
           -B option (defaults to 50%).  --BB2200%% specifies that a change with addition and deletion compared to 20% or
       ...
       --find-copies-harder
           ...
           than one --CC option has the same effect.
       ...
       -l<num>
           The --MM and --CC options require O(n^2) processing time where n is the number of potential rename/copy
       ...
       -S<string>
           ...
           of that block since it first came into being: use the feature iteratively to feed the interesting block in
           the preimage back into --SS, and keep going until you get the very first version of the block.
       ...
       -O<orderfile>
           ...
           The output order is determined by the order of glob patterns in <orderfile>. All files with pathnames that
           match the first pattern are output first, all files with pathnames that match the second pattern (but not
           the first) are output next, and so on. All files with pathnames that do not match any pattern are output
           last, as if there was an implicit match-all pattern at the end of the file. If multiple pathnames have the
           same rank (they match the same pattern but no earlier patterns), their output order relative to each other
           is the normal order.
           ...
           Patterns have the same syntax and semantics as patterns used for fnmatch(3) without the FNM_PATHNAME flag,
           except a pathname also matches a pattern if removing any number of the final pathname components matches
           the pattern. For example, the pattern "ffoooo**bbaarr" matches "ffooooaassddffbbaarr" and "ffoooo//bbaarr//bbaazz//aassddff" but not
           "ffoooobbaarrxx".
...
GGEENNEERRAATTIINNGG PPAATTCCHH TTEEXXTT WWIITTHH --PP
       ...
       the GGIITT__DDIIFFFF__OOPPTTSS environment variables.
       ...
       What the -p option produces is slightly different from the traditional diff format:
        ...
        4. All the ffiillee11 files in the output refer to files before the commit, and all the ffiillee22 files refer to files
...
CCOOMMBBIINNEEDD DDIIFFFF FFOORRMMAATT
       ...
       the --mm option to any of these commands to force generation of diffs with individual parents of a merge.
       ...
       A "combined diff" format looks like this:
        ...
        2. It is followed by one or more extended header lines (this example shows a merge with two parents):
           ...
           The mmooddee <<mmooddee>>,,<<mmooddee>>....<<mmooddee>> line appears only if at least one of the <mode> is different from the rest.
        ...
        3. It is followed by two-line from-file/to-file header
           ...
           However, if the --combined-all-paths option is provided, instead of a two-line from-file/to-file you get a
           N+1 line from-file/to-file header, where N is the number of parents in the merge commit
           ...
           This extended format can be useful if rename or copy detection is active, to allow you to see the original
           name of the file in different parents.

        4. Chunk header format is modified to prevent people from accidentally feeding it to ppaattcchh --pp11. Combined diff
           format was created for review of merge commit changes, and was not meant to be applied. The change is
           similar to the change in the extended _i_n_d_e_x header:
...
DDIISSCCUUSSSSIIOONN
       ...
       •   Commit log messages are typically encoded in UTF-8, but other extended ASCII encodings are also supported.
           This includes ISO-8859-x, CP125x and many others, but _n_o_t UTF-16/32, EBCDIC and CJK multi-byte encodings
       ...
       to use legacy encodings, Git does not forbid it. However, there are a few things to keep in mind.
        ...
        1. _g_i_t _c_o_m_m_i_t and _g_i_t _c_o_m_m_i_t_-_t_r_e_e issues a warning if the commit log message given to it does not look like a
           valid UTF-8 string, unless you explicitly say your project uses a legacy encoding. The way to say this is
           to have i18n.commitencoding in ..ggiitt//ccoonnffiigg file, like this:
        ...
        2. _g_i_t _l_o_g, _g_i_t _s_h_o_w, _g_i_t _b_l_a_m_e and friends look at the eennccooddiinngg header of a commit object, and try to
           ...
           with ii1188nn..llooggOOuuttppuuttEEnnccooddiinngg in ..ggiitt//ccoonnffiigg file, like this:
...
CCOONNFFIIGGUURRAATTIIOONN
       ...
       i18n.logOutputEncoding
           Encoding to use when displaying logs. (See _D_i_s_c_u_s_s_i_o_n above.) Defaults to the value of ii1188nn..ccoommmmiittEEnnccooddiinngg
       ...
       log.showRoot
           If ffaallssee, ggiitt lloogg and related commands will not treat the initial commit as a big creation event. Any root
           commits in ggiitt lloogg --pp output would be shown without a diff attached. The default is ttrruuee.
       ...
       notes.displayRef
           ...
           This setting can be disabled by the ----nnoo--nnootteess option, overridden by the GGIITT__NNOOTTEESS__DDIISSPPLLAAYY__RREEFF environment
           variable, and overridden by the ----nnootteess==<<rreeff>> option.
